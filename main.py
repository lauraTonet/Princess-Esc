...
main.py
-------
Jogo simples feito em Python + Pygame para a atividade de Pensamento
Computacional. Tema: "Princesa em Fuga".

ESTILO: jogo lateral, parecido com o jogo do dinossauro sem internet do
navegador. A princesa fica do lado esquerdo da tela e CORRE automaticamente.
Os obstaculos surgem pela direita e se movem para a esquerda. A jogadora
controla apenas o PULO, ou seja, move-se somente no eixo Y (item 13).

OBJETIVO: ajudar a princesa a resgatar o principe, sobrevivendo o maior
tempo possivel. Quanto mais tempo sem bater nos obstaculos, maior a
pontuacao.

COMO PERSONALIZAR O TEMA:
Troque os textos do bloco "TEMA DO JOGO" logo abaixo e substitua as imagens
da pasta bases/imagens/ (mantendo os mesmos nomes de arquivo).
"""
...
# ----------------------------------------------------------------------
# TELA 4: FIM DE JOGO  (item 18)
# ----------------------------------------------------------------------
def tela_fim(nome, pontuacao):
    """
    Mostra a pontuacao da partida e o competidor com maior numero de
    pontos. Permite jogar de novo ou sair.
    """
    melhor = obter_melhor_jogador(ARQUIVO_LOG)
...
# ----------------------------------------------------------------------
# ENCERRAMENTO E LOOP PRINCIPAL
# ----------------------------------------------------------------------
def encerrar():
    """Fecha o jogo completamente (item 20)."""
    pygame.quit()
    sys.exit()


def main():
    """Liga as telas em sequencia: nome -> boas-vindas -> partida -> fim."""
    while True:
        nome = tela_nome()
